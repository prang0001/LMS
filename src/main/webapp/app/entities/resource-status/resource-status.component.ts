...
@Component({
    selector: 'jhi-resource-status',
    templateUrl: './resource-status.component.html'
})
export class ResourceStatusComponent implements OnInit, OnDestroy {
    ...
    private paginateResourceStatuses(data: IResourceStatus[], headers: HttpHeaders) {
        ...
        for (let i = 0; i < data.length; i++) {
            this.resourceStatuses.push(data[i]);
        }
    }
