...
@Component({
    selector: 'jhi-library-resource',
    templateUrl: './library-resource.component.html'
})
export class LibraryResourceComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.libraryResourceService
            ...
            .subscribe(
                (res: HttpResponse<ILibraryResource[]>) => this.paginateLibraryResources(res.body, res.headers),
    ...
    trackId(index: number, item: ILibraryResource) {
        return item.id;
    }
