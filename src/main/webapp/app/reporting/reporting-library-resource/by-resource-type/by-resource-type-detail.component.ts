...
@Component({
    selector: 'jhi-by-resource-type-detail',
    templateUrl: './by-resource-type-detail.component.html'
})
export class ByResourceTypeDetailComponent implements OnInit, OnDestroy {
    libraryResources: ILibraryResource[];
    byResourceTypes: IResourceType[];
    byResourceType: IResourceType;
    ...
    loadAll() {
        this.activatedRoute.data.subscribe(({ byResourceType }) => {
            this.byResourceType = byResourceType;
            console.log(this.byResourceType);
        });
    }
