...
import { WaitingListComponent } from 'app/entities/waiting-list/waiting-list.component';
...
describe('Component Tests', () => {
    describe('WaitingList Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.waitingLists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
