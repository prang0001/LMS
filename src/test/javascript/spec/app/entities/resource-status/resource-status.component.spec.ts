...
import { ResourceStatusComponent } from 'app/entities/resource-status/resource-status.component';
...
describe('Component Tests', () => {
    describe('ResourceStatus Management Component', () => {
        let comp: ResourceStatusComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ResourceStatusComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.resourceStatuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
