...
import { LibraryResourceComponent } from 'app/entities/library-resource/library-resource.component';
...
describe('Component Tests', () => {
    describe('LibraryResource Management Component', () => {
        let comp: LibraryResourceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [LibraryResourceComponent],
                providers: [
                    {
                ...
                .overrideTemplate(LibraryResourceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.libraryResources[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
